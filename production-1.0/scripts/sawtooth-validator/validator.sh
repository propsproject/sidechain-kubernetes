...
sed 's/1024\**4/(1024**4)*4/g' /usr/lib/python3/dist-packages/sawtooth_validator/database/lmdb_nolock_database.backup.py > /usr/lib/python3/dist-packages/sawtooth_validator/database/lmdb_nolock_database.py
# End Changes
